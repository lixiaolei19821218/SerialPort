    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (qrRow != null)
            {
                ...
                //记录查询
                sql = string.Format("INSERT INTO \"DB2ADMIN\".\"QUERIES\"(\"IPADDRESS\", \"QUERYTIME\", \"QRCODEID\") VALUES('{0}', '{1}', '{2}'", Request.UserHostAddress, DateTime.Now, qrRow["Id"].ToString());
                weixinDB.Insert(sql);
                ...
                int index = qrTable.Rows.IndexOf(qrRow);
